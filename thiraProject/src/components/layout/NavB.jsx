...
const NavB = () => {
  return (
    <div className="p-3 flex justify-between bg-black ">
      <div className="flex justify-center text white"><img src={Logo} alt="Thira" className="h-12 w-auto" /></div>
      ...
      <div className="relative">
        <Button variant="text" className="!text-white !capitalize !py-2 !px-4 !rounded-full">
          <AddIcon /> Create
        </Button>
